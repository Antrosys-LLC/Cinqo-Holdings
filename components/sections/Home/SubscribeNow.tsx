...
export default function SubscribeNow() {
  ...
  return (
    <motion.section
      ...
      className="relative bg-white mx-[50px] mt-[10px] mb-[70px] rounded-[5px]"
    >
      <div className="bg-white bg-[url('/images/subscribe/bg.jpg')] bg-center bg-auto bg-no-repeat overflow-hidden text-cream-50 text-center rounded-[5px] px-4 py-24 flex flex-col items-center gap-6">
