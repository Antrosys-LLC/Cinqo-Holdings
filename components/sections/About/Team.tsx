...
const executives = [
  ...
  { name: "Mohd Ali", designation: "Operational Manager – THC Facilities Management", image: "https://placehold.co/500x600/dbeafe/1e3a8a?text=Mohd+Ali" },
  { name: "Collins", designation: "Operational Manager – THC Fit Out", image: "https://placehold.co/500x600/dbeafe/1e3a8a?text=Collins" },
