...
export default function Intro({ business }: { business: BusinessData }) {
  const heroSlide: HeroSlideV2 = {
    ...
    ...(business.slug === "cinqo-holding-investments" && { imageClassName: "object-[center_30%]" }),
    ...(business.slug === "cinqo-contracting" && { imageClassName: "object-[center_15%]" }),
  };
      ...
      <div className="relative w-full py-2">
        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-6 md:px-12">
          ...
          <div className="flex items-start justify-end">
            <p className={`text-[1.375rem] text-black/80 leading-relaxed font-light max-w-2xl whitespace-pre-line -translate-y-16 ${business.slug === "thc-facilities-management" || business.slug === "cinqo-fitout" ? "-translate-x-4" : business.slug === "cinqo-trading" ? "translate-x-0" : business.slug === "cinqo-contracting" || business.slug === "cinqo-flooring-coating-technologies" ? "-translate-x-4" : business.slug === "cinqo-holding-investments" ? "translate-x-4" : "-translate-x-8"}`}>
              {business.introText}
            </p>
          </div>
        </div>
